...
<div class="container mt-5 mb-5 pb-4">
    ...
    <div class="tarifa motivation row" >
        <div class="col-sm border-right border-dark tarifah p-3">
            ...
            <div class="text-center">
                <a class="boton-tarifa btn mb-4" href="{{ URL::to('./register?option=Mensual')}}">ME APUNTO!</a>  
            </div>            
        </div>
        <div class="col-sm border-right border-dark tarifah p-3">
            ...
            <p class="decription-tarifa m-4 text-center ">SALA DE MUSCULACION, ZONA DE CARDIO Y ACTIVIDADES DIRIGIDAS INCLUIDAS</p> 
            <div class="text-center">
                <a class="boton-tarifa btn mb-4" href="{{ URL::to('./register?option=Trimestral')}}">ME APUNTO!</a>  
            </div>     
        </div>
        <div class="col-sm tarifah p-3">
            <h2 class="title m-4 text-center font-weight-bold text-white">CUOTA ANUAL</h2>
            <h5 class="precio-tarifa m-4 text-center ">200€</h5>
            <p class="decription-tarifa m-4 text-center ">SALA DE MUSCULACION, ZONA DE CARDIO Y ACTIVIDADES DIRIGIDAS INCLUIDAS</p>    
            <div class="text-center">
                <a class="boton-tarifa btn mb-4" href="{{ URL::to('./register?option=Anual')}}">ME APUNTO!</a>  
            </div>            
        </div>
    </div>
</div>
