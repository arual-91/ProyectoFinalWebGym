...
Route::delete('/perfil/perfil/delete/{order}', [ProfileController::class,'delete_order'])->name('profile.delete_order')->middleware('auth');
Route::delete('/perfil/perfil/delete_booking/{booking}', [ScheduleController::class,'delete_booking'])->name('schedule.delete_booking_profile')->middleware('auth');

Route::get('/perfil/ventas', [ProfileController::class,'sales'])->middleware('auth');
Route::delete('/perfil/ventas/delete/{order}', [ProfileController::class,'delete_order'])->name('profile.delete_sales')->middleware('auth');

Route::get('/perfil/reservas', [ScheduleController::class,'show_booking'])->middleware('auth');
Route::delete('/perfil/reservas/delete/{order}', [ProfileController::class,'delete_booking'])->name('profile.delete_booking')->middleware('auth');

Route::get('/perfil/usuarios', [ProfileController::class,'user'])->name('profile.user')->middleware('auth');
Route::delete('/perfil/usuarios/{id}', [ProfileController::class,'delete_user'])->name('profile.delete_user')->middleware('auth');

Route::get('/perfil/productos', [ProfileController::class,'product'])->middleware('auth');
Route::delete('/perfil/productos/delete/{product}', [ProfileController::class,'delete_product'])->name('profile.delete_product')->middleware('auth');
...
Route::delete('/perfil/actividades/delete/{activity}', [ProfileController::class,'delete_activity'])->name('profile.delete_activity')->middleware('auth');
